...
O desafio inicial foi a criação do layout de uma página com informações climáticas como o modelo mostrado em <a href="#-layout-figma">Layout</a>, após a confecção do modelo, decidir integrar com uma API para pegar os dados dinâmicamente.
...
No projeto usado, utilizamos como referência a cidade de Maringá, e consequentemente seus dados meteorologicos. Para a utilização de outras cidades, é necessário modificar as coordenadas de latitude e longitude.
